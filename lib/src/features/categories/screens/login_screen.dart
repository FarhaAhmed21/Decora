...
import 'package:decora/src/features/categories/screens/forgot_password_screen.dart';
import 'package:decora/src/features/categories/screens/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(loc.email, style: TextStyle(fontSize: size.width * 0.04)),
  ...
  Widget customField(AppLocalizations loc) {
    return TextField(
