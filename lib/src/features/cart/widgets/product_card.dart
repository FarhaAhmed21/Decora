                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 6,
                        children: [
                          _buildTag(AppLocalizations.of(context)!.dining,context),
                          _buildTag(AppLocalizations.of(context)!.furniture,context),
                          _buildTag(AppLocalizations.of(context)!.wood,context),
                        ],
                      ),
