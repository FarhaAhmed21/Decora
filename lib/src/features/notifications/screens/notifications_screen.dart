...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> loadNotifications() async {
    ...
    try {
      final notis = await _notificationService.getUserNotifications();
  ...
  String formatSectionDate(String fullTime) {
    try {
  ...
  List<Widget> _buildGroupedNotifications() {
    ...
    for (final noti in _notifications) {
      final section = formatSectionDate(noti['time']);
